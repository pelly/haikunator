...
module Haikunator
  class << self
    ...
    def adjectives
      @adjectives ||= (adjectives1 + adjectives2).uniq.sort
    end
    
    def nouns
      @nouns ||= (nouns1 + nouns2).uniq.sort
    end
    ...
    # from mobyproject.org source code (specifically - https://github.com/moby/moby/blob/master/pkg/namesgenerator/names-generator.go)
    def adjectives2
      [		"admiring",
		"adoring",
		"affectionate",
